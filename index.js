...
*/
console.log(createMenuItem("Hot dog", 3, "fast food"))
console.log(createMenuItem("Tamales", 6, "Mexican food"))
console.log(createMenuItem("Burger", 5, "fast food"))
...
reviews.push({name: "Elon Musk", rating: 42, feedback: "Needs more Mars"})
console.log(reviews)
